...
export const Hero = () => {
  return (
    <div className="border border-amber-500 flex justify-center items-center h-[90vh] flex-col gap-y-4  w-full max-w-5xl mx-auto">
      ...
      <h1 className="text-5xl font-bold mt-10 mb-2">
        Share Files with a
      ...
      <p className="max-w-2xl font-body text-2xl text-center text-muted-foreground">
      ...
      <div className="w-full justify-center gap-x-4 flex mt-2 items-center mx-auto">
        <div className="flex items-center ">
          <Dot className="text-teal-400 size-8"></Dot>
          <p className="font-body">No installation required</p>
        </div>
        <div className="flex items-center ">
          <Dot className="text-red-400 size-8"></Dot>
